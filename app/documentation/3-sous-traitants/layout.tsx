...
export const metadata: Metadata = {
  title: "Sous-traitants -Chantier Direct",
  description: "Sous-traitants de Chantier Direct",
    ...
    images: [
        {
            ...
            width: 1200,
            height: 630,
            alt: "Sous-traitants - Chantier Direct",
        },
    ],
    title: "Sous-traitants - Chantier Direct",
    description: "Sous-traitants de Chantier Direct",
  ...
  alternates: {
    canonical: "https://www.chantier-direct.fr/documentation/3-sous-traitants",
  },
};
...
export default function Documentation3SousTraitantsLayout({
  children,
}: Readonly<{
