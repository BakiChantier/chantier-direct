...
export const metadata: Metadata = {
  title: "Conditions d'utilisation -Chantier Direct",
  description: "Conditions d'utilisation de Chantier Direct",
    ...
    images: [
        {
            ...
            width: 1200,
            height: 630,
            alt: "Conditions d'utilisation - Chantier Direct",
        },
    ],
    title: "Conditions d'utilisation - Chantier Direct",
    description: "Conditions d'utilisation de Chantier Direct",
  ...
  alternates: {
    canonical: "https://www.chantier-direct.fr/legal/terms",
  },
};
