...
export const metadata: Metadata = {
  title: "Présentation -Chantier Direct",
  description: "Présentation de Chantier Direct",
    ...
    images: [
        {
            ...
            width: 1200,
            height: 630,
            alt: "Présentation - Chantier Direct",
        },
    ],
    title: "Présentation - Chantier Direct",
    description: "Présentation de Chantier Direct",
  ...
  alternates: {
    canonical: "https://www.chantier-direct.fr/documentation/1-1-presentation",
  },
};
...
export default function Documentation11PresentationLayout({
  children,
}: Readonly<{
